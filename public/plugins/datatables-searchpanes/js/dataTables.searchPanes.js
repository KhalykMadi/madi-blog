...
(function () {
    ...
    var SearchPane = /** @class */ (function () {
         ...
         * @param idx the index.blade.php of the column for this pane
         * @returns {object} the pane that has been created, including the table and the index.blade.php of the pane
         */
        function SearchPane(paneSettings, opts, idx, layout, panesContainer, panes) {
            ...
            //  reassign all of the panes indexes to the new index.blade.php of the column.
         ...
         *
         * @param rowIdx The current row index.blade.php to be compared
         ...
         * @param dataIndex the row index.blade.php
         */
        ...
        SearchPane.prototype._searchExtras = function () {
            ...
            // If null index.blade.php is found then search for empty cells as a filter.
            if (nullIndex > -1) {
                filters[nullIndex] = '';
            }
    ...
    var SearchPanes = /** @class */ (function () {
                ...
                // more selections may be made in that pane.
                    ...
                    for (var _b = 0, _c = this.s.panes; _b < _c.length; _b++) {
                        ...
                        if (pane.s.dtPane !== undefined) {
                            ...
                            // so set filterPane to that panes index.blade.php
        ...
        SearchPanes.prototype._cascadeRegen = function (newSelectionList, selectTotal) {
            ...
            // If only one pane has been selected then take note of its index.blade.php
            var solePane = -1;
            if (newSelectionList.length === 1 && selectTotal !== null && selectTotal !== 0) {
                solePane = newSelectionList[0].index;
            }
        ...
        SearchPanes.prototype._makeCascadeSelections = function (newSelectionList) {
            ...
            for (var i = 0; i < newSelectionList.length; i++) {
                ...
                // in a different order to the pane index.blade.php we must identify
                // which pane has the index.blade.php of the selection. This is also important for colreorder etc
                for (var _i = 0, _a = this.s.panes; _i < _a.length; _i++) {
                    var pane = _a[_i];
                    _loop_1(pane);
                }
