...
(function (factory) {
    ...
    Mapael.prototype = {
        ...
        showElemByRange: function(ranges, elems, hiddenOpacity, animDuration) {
            ...
            $.each(ranges, function (valueIndex) {
                ...
                $.each(elems, function (id) {
                    ...
                    // Check existence of this value index.blade.php
         ...
         * @param legendIndex index.blade.php of the legend in the conf array
         */
         ...
         * @param legendIndex corresponding legend index.blade.php
