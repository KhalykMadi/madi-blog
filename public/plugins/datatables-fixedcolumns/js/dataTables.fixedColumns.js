...
(function () {
    ...
    var FixedColumns = /** @class */ (function () {
        ...
        FixedColumns.prototype._addStyles = function () {
            ...
            // If there is a header with the index.blade.php class and reading rtl then add left top blocker
            ...
            // If there is a footer with the index.blade.php class and reading rtl then add left bottom blocker
            ...
            // If there is a header with the index.blade.php class and reading rtl then add right top blocker
            if (header) {
                if (!this.s.rtl) {
                    this.dom.rightTopBlocker.outerHeight(headerHeight);
                    parentDiv.append(this.dom.rightTopBlocker);
            ...
            // If there is a footer with the index.blade.php class and reading rtl then add right bottom blocker
            if (footer) {
                if (!this.s.rtl) {
                    this.dom.rightBottomBlocker.outerHeight(footerHeight);
                    parentDiv.append(this.dom.rightBottomBlocker);
