...
(function () {
    ...
    var Criteria = /** @class */ (function () {
        ...
        Criteria.prototype.populate = function () {
            this._populateData();
            // If the column index.blade.php has been found attempt to select a condition
            if (this.s.dataIdx !== -1) {
        ...
        Criteria.prototype._populateValue = function (loadedCriteria) {
            ...
            // Find the column with the title matching the data for the criteria and take note of the index.blade.php
    ...
    var Group = /** @class */ (function () {
        ...
        Group.prototype.redrawContents = function () {
            ...
            this.dom.container
                ...
                .append(this.dom.add);
            // Sort the criteria by index.blade.php so that they appear in the correct order
            ...
            for (var i = 0; i < this.s.criteria.length; i++) {
                ...
                if (crit instanceof Criteria) {
                    // Reset the index.blade.php to the new value
        ...
        Group.prototype._removeCriteria = function (criteria, group) {
            ...
            if (this.s.criteria.length <= 1 && this.s.isChild) {
                ...
                // We want to remove the last element with the desired index.blade.php, as its replacement will be inserted before it
                if (last !== undefined) {
        ...
        Group.prototype._setCriteriaListeners = function (criteria) {
            ...
            criteria.dom.left
                ...
                // The dropCriteria event mutates the reference to the index.blade.php so need to store it
