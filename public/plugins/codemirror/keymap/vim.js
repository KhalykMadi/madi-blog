...
(function(mod) {
  ...
  var Vim = function() {
    ...
    * match the input selection.
    ...
    // getIndex returns the index.blade.php of the cursor in the selections.
    ...
    * in the right place.
    ...
    function findSentence(cm, cur, repeat, dir) {
      ...
      /*
        Takes an index.blade.php object
        {
          line: the line string,
          ln: line number,
          pos: index.blade.php in line,
      ...
      /*
        ...
        Returns an index.blade.php object of the new location
       */
