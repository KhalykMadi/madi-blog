...
$.extend( KeyTable.prototype, {
	...
	/**
	 * Focus on a cell
	 * @param  {integer} row    Row index.blade.php
	 * @param  {integer} column Column index.blade.php
	 */
	...
	/**
	 * Is the cell focused
	 * @param  {object} cell Cell index.blade.php to check
	 ...
	 *   visible row index.blade.php (from the whole data set) - NOT the data index.blade.php
	 * @param  {integer} [column] Not required if a cell is given as the first
	 *   parameter. Otherwise this is the column data index.blade.php for the cell to
	 *   focus on
	...
	_shift: function ( e, direction, keyBlurable )
	{
		...
		var
			row = currRow,
			column = columns[ currCol ]; // row is the display, column is an index.blade.php
...
KeyTable.defaults = {
	...
	/**
	 * Tab index.blade.php for where the table should sit in the document's tab flow
	 * @type {integer|null}
	 */
	tabIndex: null
};
