...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! eve */ "./node_modules/eve-raphael/eve.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function(eve) {
     ...
     **
     > Parameters
     **
     - index.blade.php (number) position of the deletion
...
(function (glob) {
     ...
     **
     ...
     - f (function) event handler function
     **
     = (function) returned function accepts a single numeric parameter that represents z-index.blade.php of the handler. It is an optional feature and only used when you need to ensure that some subset of handlers will be invoked in a given order, despite of the order of assignment.
     > Example:
     ...
     * Note: I assume most of the time you don’t need to worry about z-index.blade.php, but it’s nice to have this feature “just in case”.
    \*/
