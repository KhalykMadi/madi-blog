...
var FullCalendar = (function (exports) {
    ...
    ***************************************************************************** */
    ...
    function arrayToUtcDate(a) {
        // according to web standards (and Safari), a month index.blade.php is required.
    ...
    */
    var PositionCache = /** @class */ (function () {
        ...
        // Given a left offset (from document left), returns the index.blade.php of the el that it horizontally intersects.
        ...
        // Given a top offset (from document top), returns the index.blade.php of the el that it vertically intersects.
        // If no intersection is made, returns undefined.
        ...
        // Gets the width of the element at the given index.blade.php
        PositionCache.prototype.getWidth = function (leftIndex) {
            return this.rights[leftIndex] - this.lefts[leftIndex];
        };
        // Gets the height of the element at the given index.blade.php
    ...
    */
    ...
    var DateProfileGenerator = /** @class */ (function () {
        ...
        DateProfileGenerator.prototype.initHiddenDays = function () {
            ...
            var isHiddenDayHash = []; // is the day-of-week hidden? (hash with day-of-week-index.blade.php -> bool)
            var dayCnt = 0;
            var i;
        ...
        // `day` is a day-of-week index.blade.php (0-6), or a Date (used for UTC)
    ...
    */
    ...
    var DaySeriesModel = /** @class */ (function () {
        ...
        DaySeriesModel.prototype.sliceRange = function (range) {
            var firstIndex = this.getDateDayIndex(range.start); // inclusive first index.blade.php
            var lastIndex = this.getDateDayIndex(addDays(range.end, -1)); // inclusive last index.blade.php
        ...
        // Given a date, returns its chronolocial cell-index.blade.php from the first cell of the grid.
    ...
    */
    var RefMap = /** @class */ (function () {
        ...
        // NOTE: this method has become less valuable now that we are encouraged to map order by some other index.blade.php
    ...
    */
    ...
    var TimeColsSlatsCoords = /** @class */ (function () {
        ...
        TimeColsSlatsCoords.prototype.computeTimeTop = function (duration) {
            ...
            // an integer index.blade.php of the furthest whole slat
