...
$.extend( Buttons.prototype, {
	 ...
	 * @param  {int|string} Button index.blade.php
	 * @return {function}
	 *//**
	 ...
	 * @param {int|string} [idx] Button index.blade.php for where to insert the button
	...
	/**
	 * Get a button's index.blade.php
	 *
	 * This is internally recursive
	 * @param {element} node Button to get the index.blade.php of
	 * @return {string} Button index.blade.php
	 */
	 ...
	 * @param  {int|string} node Button index.blade.php
	 * @return {string} Button text
	 *//**
	 * Set the text for a button
	 * @param  {int|string|function} node Button index.blade.php
...
Buttons.buttonSelector = function ( insts, selector )
{
	...
	var run = function ( selector, inst ) {
		...
		if ( selector === null || selector === undefined || selector === '*' ) {
			...
			// Main button index.blade.php selector
			...
			if ( selector.indexOf( ',' ) !== -1 ) {
				...
				// Sub-button index.blade.php selector
...
DataTable.Api.register( 'button().index.blade.php()', function () {
	var idx = null;
